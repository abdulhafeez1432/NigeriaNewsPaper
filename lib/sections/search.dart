...
class _SearchPostState extends State<SearchPost> {
  final searchPostCubit = PostCubit(postRepository: PostRepository());
          ...
          child: TextField(
            ...
            onSubmitted: (value) {
              if (value.isNotEmpty && value != null) {
                searchQuery = value;
                searchPostCubit.getSearchPosts(searchQuery: value);
              }
            },
                    ...
                    builder: (context, state) {
                      if (state is PostLoading) {
                        ...
                        return CustomErrorWidget(
                          ...
                          onRetryPressed: () => searchPostCubit.getSearchPosts(
